...
namespace CapaDesconectada {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(string CustomerID, string CompanyName, string ContactName, string ContactTitle, string City, string Address, string Region, string PostalCode, string Country, string Phone, string Fax) {
...
namespace CapaDesconectada.DataSet1TableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Customers] ([CustomerID], [CompanyName], [ContactName], [ContactTitle], [City], [Address], [Region], [PostalCode], [Country], [Phone], [Fax]) VALUES (@CustomerID, @CompanyName, @ContactName, @ContactTitle, @City, @Address, @Region, @PostalCode, @Country, @Phone, @Fax);
SELECT CustomerID, CompanyName, ContactName, ContactTitle, City, Address, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Customers] SET [CustomerID] = @CustomerID, [CompanyName] = @CompanyName, [ContactName] = @ContactName, [ContactTitle] = @ContactTitle, [City] = @City, [Address] = @Address, [Region] = @Region, [PostalCode] = @PostalCode, [Country] = @Country, [Phone] = @Phone, [Fax] = @Fax WHERE (([CustomerID] = @Original_CustomerID) AND ([CompanyName] = @Original_CompanyName) AND ((@IsNull_ContactName = 1 AND [ContactName] IS NULL) OR ([ContactName] = @Original_ContactName)) AND ((@IsNull_ContactTitle = 1 AND [ContactTitle] IS NULL) OR ([ContactTitle] = @Original_ContactTitle)) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Region = 1 AND [Region] IS NULL) OR ([Region] = @Original_Region)) AND ((@IsNull_PostalCode = 1 AND [PostalCode] IS NULL) OR ([PostalCode] = @Original_PostalCode)) AND ((@IsNull_Country = 1 AND [Country] IS NULL) OR ([Country] = @Original_Country)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Fax = 1 AND [Fax] IS NULL) OR ([Fax] = @Original_Fax)));
SELECT CustomerID, CompanyName, ContactName, ContactTitle, City, Address, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        CustomerID, CompanyName, ContactName, ContactTitle, City, Address, " +
                "Region, PostalCode, Country, Phone, Fax\r\nFROM            Customers";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"UPDATE       Customers
SET                CustomerID = @CustomerID, CompanyName = @CompanyName, ContactName = @ContactName, ContactTitle = @ContactTitle, City = @City, Address = @Address, Region = @Region, PostalCode = @PostalCode, 
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, City, Address, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
            ...
            this._commandCollection[2].CommandText = "DELETE FROM [dbo].[Customers]\r\n      WHERE CustomerID=@customerID\r\n\r\n\r\n\r\n";
            ...
            this._commandCollection[3].CommandText = "SELECT        CustomerID, CompanyName, ContactName, ContactTitle, City, Address, " +
                "Region, PostalCode, Country, Phone, Fax\r\nFROM            Customers\r\nWHERE       " +
        ...
        public virtual int FillByCustomerID(DataSet1.CustomersDataTable dataTable, string customerID) {
        ...
        public virtual DataSet1.CustomersDataTable GetDataByCustomerID(string customerID) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((customerID == null)) {
                throw new global::System.ArgumentNullException("customerID");
            }
        ...
        public virtual int Delete(string Original_CustomerID, string Original_CompanyName, string Original_ContactName, string Original_ContactTitle, string Original_City, string Original_Address, string Original_Region, string Original_PostalCode, string Original_Country, string Original_Phone, string Original_Fax) {
        ...
        public virtual int Insert(string CustomerID, string CompanyName, string ContactName, string ContactTitle, string City, string Address, string Region, string PostalCode, string Country, string Phone, string Fax) {
            if ((CustomerID == null)) {
                throw new global::System.ArgumentNullException("CustomerID");
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_Phone, 
                    string Original_Fax) {
            return this.Update(Original_CustomerID, CompanyName, ContactName, ContactTitle, City, Address, Region, PostalCode, Country, Phone, Fax, Original_CustomerID, Original_CompanyName, Original_ContactName, Original_ContactTitle, Original_City, Original_Address, Original_Region, Original_PostalCode, Original_Country, Original_Phone, Original_Fax);
        }
        ...
        public virtual int ActualizarCliente(string CustomerID, string CompanyName, string ContactName, string ContactTitle, string City, string Address, string Region, string PostalCode, string Country, string Phone, string Fax) {
